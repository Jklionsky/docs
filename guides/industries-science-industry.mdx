...
description: "Industry sub-categories for Science & Industry super-categories"
---

<AccordionGroup>
  <Accordion title="Science and Engineering - science-and-engineering">
  ...
  <Accordion title="Biotechnology - biotechnology-0400">
    - **Bioinformatics** - `bioinformatics`
    - **Biometrics** - `biometrics`
    - **Biopharma** - `biopharma`
    - **Biotechnology** - `biotechnology`
  ...
  <Accordion title="Health Care - health-care-a53c">
  ...
  <Accordion title="Manufacturing - manufacturing-133d">
  ...
  <Accordion title="Agriculture and Farming - agriculture-and-farming">
    - **AgTech** - `agtech`
  ...
  <Accordion title="Energy - energy-2b83">
    - **Battery** - `battery`
    - **Biofuel** - `biofuel`
  ...
  <Accordion title="Sustainability - sustainability-5142">
    - **Biofuel** - `biofuel`
    - **Biomass Energy** - `biomass-energy`
  ...
  <Accordion title="Natural Resources - natural-resources-26a5">
    - **Biofuel** - `biofuel`
    - **Biomass Energy** - `biomass-energy`
    - **Fossil Fuels** - `fossil-fuels`
    - **Mineral** - `mineral`
  ...
  <Accordion title="Hardware - hardware-2e6e">
  ...
  <Accordion title="Navigation and Mapping - navigation-and-mapping">
    - **GPS** - `gps`
  ...
  <Accordion title="Government and Military - government-and-military">
    - **CivicTech** - `civictech`
  ...
  <Accordion title="Sports - sports-8f4d">
...
To filter by science & industry industries in your API calls, use the industry permalink as the value for your industry filter parameter:

```
GET /api/v1/deals?industries=biotechnology,renewable-energy
```
