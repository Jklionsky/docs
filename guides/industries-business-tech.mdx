...
description: "Industry sub-categories for Business & Technology super-categories"
---

<AccordionGroup>
  <Accordion title="Artificial Intelligence (AI) - artificial-intelligence-e551">
  ...
  <Accordion title="Financial Services - financial-services-d7b6">
  ...
  <Accordion title="Payments - payments-cb33">
    - **Billing** - `billing`
    - **Bitcoin** - `bitcoin-1c16`
    - **Credit Cards** - `credit-cards`
    - **Cryptocurrency** - `cryptocurrency`
  ...
  <Accordion title="Blockchain and Cryptocurrency - blockchain-and-cryptocurrency">
    - **Bitcoin** - `bitcoin-1c16`
  ...
  <Accordion title="Data and Analytics - data-and-analytics">
  ...
  <Accordion title="Information Technology - information-technology-4fe3">
  ...
  <Accordion title="Internet Services - internet-services">
  ...
  <Accordion title="Software - software-85b6">
  ...
  <Accordion title="Privacy and Security - privacy-and-security">
    - **Cloud Security** - `cloud-security-db34`
    - **Cyber Security** - `cyber-security`
    - **DRM** - `drm`
    - **E-Signature** - `e-signature`
  ...
  <Accordion title="Professional Services - professional-services-abe5">
    - **Accounting** - `accounting`
  ...
  <Accordion title="Administrative Services - administrative-services">
  ...
  <Accordion title="Sales and Marketing - sales-and-marketing">
  ...
  <Accordion title="Advertising - advertising-f0bd">
  ...
  <Accordion title="Lending and Investments - lending-and-investments">
    - **Angel Investment** - `angel-investment`
    - **Banking** - `banking`
    - **Commercial Lending** - `commercial-lending`
    - **Consumer Lending** - `consumer-lending`
  ...
  <Accordion title="Apps - apps-2683">
    - **App Discovery** - `app-discovery`
    - **Apps** - `apps`
    - **Consumer Applications** - `consumer-applications`
    - **Enterprise Applications** - `enterprise-applications`
  ...
  <Accordion title="Platforms - platforms">
    - **Android** - `android-3f49`
...
To filter by business & technology industries in your API calls, use the industry permalink as the value for your industry filter parameter:
