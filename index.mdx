...
<CardGroup cols={2}>
  <Card title="Connect Fundable MCP" icon="plug" href="/fundable-mcp">
    Research companies, investors, markets, and contacts directly from an MCP-compatible AI assistant.
  </Card>
  ...
  <Card title="Choose endpoints and filters" icon="filter" href="/guides/endpoint-and-filter-selection">
    Select and combine the right company, deal, investor, people, and filter endpoints.
  </Card>
</CardGroup>
